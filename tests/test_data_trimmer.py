...
class  TestDataTrimmer(TestPreprocessor): 
    ...
    def test_C02T03_trim_auto(self):
        """ Must trim all the constant columns by using the trim_auto method. Trim all rows with consecutive zeroes from start and end. Execute trimmer with auto_trim = true. """
