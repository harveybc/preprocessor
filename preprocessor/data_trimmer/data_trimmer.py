...
class  DataTrimmer(Preprocessor):
    ...
    def parse_args(self, args):
        ...
        if (hasattr(pargs, 'output_file')): self.output_file = pargs.output_file
        if (hasattr(pargs, 'input_config_file')): self.input_config_file = pargs.input_config_file
        if (hasattr(pargs, 'output_config_file')): self.output_config_file = pargs.output_config_file
        ...
        if (hasattr(pargs, 'auto_trim')): self.auto_trim = pargs.auto_trim
