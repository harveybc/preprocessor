...
DEFAULT_VALUES = {
    'input_file': 'examples/data/phase_3.csv',  # Default path for the CSV file
    
    'output_file': 'ouput_phase_3.csv',  # Default output file for processed data
    ...
    'debug_file': 'examples/data/phase_3/phase_3_debug_out.json',  # Path to save debug information
