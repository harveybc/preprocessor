...
DEFAULT_VALUES = {
    'input_file': 'examples/data/phase_2_3.csv',  # Default path for the CSV file
    
    'output_file': 'examples/data/phase_2_3/phase_2_3.csv',  # Default output file for processed data
    ...
    'debug_file': 'examples/data/phase_2_3/phase_2_3_debug_out.json',  # Path to save debug information
    'quiet_mode': False,  # Suppress all output except for errors
    'only_low_CV': True,  # Process only low CV columns (False by default),
    'dataset_prefix': "examples/data/phase_2_3/base_",
    'target_prefix': "examples/data/phase_2_3/normalized_"
}
