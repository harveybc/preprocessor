...
def parse_args():
    ...
    # Parse known arguments first to check for plugin-specific parameters
    ...
    # Parse all arguments again with plugin parameters included
    args = parser.parse_args()
    print(f"Final args with plugin params: {args}")
