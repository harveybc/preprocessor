...
def parse_args():
    ...
    parser.add_argument('-rsc', '--remote_save_config', type=str, help='Remote URL to save the configuration.')
    parser.add_argument('-rlc', '--remote_load_config', type=str, help='Remote URL to load the configuration.')
    parser.add_argument('--remote_username', type=str, default='test', help='Username for remote configuration.')
    parser.add_argument('--remote_password', type=str, default='pass', help='Password for remote configuration.')
    ...
    parser.add_argument('--debug_file', type=str, default='debug_out.json', help='Path to save debug information.')
