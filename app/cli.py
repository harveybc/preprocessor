...
def parse_args():
    ...
    parser.add_argument('--quiet_mode', action='store_true', help='Enable quiet mode (no console output).')
    ...
    parser.add_argument('--remote_username', type=str, default='test', help='Username for remote configuration saving.')
    parser.add_argument('--remote_password', type=str, default='pass', help='Password for remote configuration saving.')
